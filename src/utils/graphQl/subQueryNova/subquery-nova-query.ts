...
export type GetTransfersByAccountSubQueryQueryVariables = Exact<{
...
export type GetTransfersByAccountSubQueryQuery = { __typename?: 'Query', historyElements?: { __typename?: 'HistoryElementsConnection', nodes: Array<{ __typename?: 'HistoryElement', transfer?: any | null, extrinsicHash?: string | null, extrinsicIdx?: number | null, blockNumber: number, address: string, timestamp: any } | null> } | null };

export type GetIndexerLastProcessedHeightSubQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type GetIndexerLastProcessedHeightSubQueryQuery = { __typename?: 'Query', _metadata?: { __typename?: '_Metadata', lastProcessedHeight?: number | null } | null };


export const GetTransfersByAccountSubQuery = gql`
    query GetTransfersByAccountSubQuery($filter: HistoryElementFilter!, $offset: Int, $first: Int) {
  historyElements(filter: $filter, offset: $offset, first: $first) {
    ...
    `;
export const GetIndexerLastProcessedHeightSubQuery = gql`
